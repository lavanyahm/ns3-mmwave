...
main (int argc, char *argv[])
{
  ...
  NS_LOG_DEBUG("LHM remoteHostAddr : "<< internetIpIfaces.GetAddress (1));
  NS_LOG_DEBUG("LHM pgw :"<<internetIpIfaces.GetAddress (0));
 ...
 NS_LOG_DEBUG("LHM epcHelper->AssignUeIpv4Address ueDevs  " << ueIpIface.GetAddress (0));
 ...
 NS_LOG_DEBUG("LHM  SetDefaultRoute epcHelper->GetUeDefaultGatewayAddress ()  "<< epcHelper->GetUeDefaultGatewayAddress ());
  ...
  NS_LOG_DEBUG("LHM SINK IP ADDRSS "<<ueIpIface.GetAddress (0));
  ...
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper.CreateFileStream ("mmWave-tcp-window_new.dat");
 ...
 // *stream2->GetStream () <<  "Time \t  packet Size "<< std::endl;
